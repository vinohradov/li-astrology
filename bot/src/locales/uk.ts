export const uk = {
  ...
  waitlist: {
    added:
      '✨ Ти у списку очікування!\n\n' +
      'Тариф «Для профі» ще в підготовці — блок «Як консультувати» записуємо протягом ~2 місяців. ' +
      'Напишу першою, як тільки відкриємо продаж.\n\n' +
      'Поки що — заглянь у каталог:',
    alreadyThere:
      'Ти вже у списку очікування 🌙 Напишу, як тільки відкриємо продаж тарифу «Для профі».',
    browseCatalog: '📚 Каталог курсів',
  },
} as const;
